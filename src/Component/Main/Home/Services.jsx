...
const Services = () => {
 ...
 const steps = [
   ...
   },
   {
     ...
     description: "We are here professional bodies conquer your desire set to return home",
   },
   {
     serial: <BsFillClockFill/>,
     title: "Schedule on Time",
     description: "We don't miss our schedule reach in time to destination Conquer your desire set to return home",
   },
   {
     serial: <BsFillPhoneFill/>,
     title: "Online Booking",
     description: "we provide you the opportunity to get the bus online conquer your desire set to return office",
   },
   {
     serial: <BsFillPersonVcardFill/>,
     title: "24/7 Support",
     description: "we are here 24/7 to help you Conquer your desire set to return destination",
   },
 ];
