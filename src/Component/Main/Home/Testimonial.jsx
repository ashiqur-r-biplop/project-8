        ...
        {slides.map((slide, index) => (
          <SwiperSlide>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-purple-600 text-gray-50">
                <img
                  src={slide.imageUrl}
                  alt=""
                  className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full bg-gray-500 "
                />
                <p className="text-xl font-semibold leadi">{slide.title}</p>
                <p className="text-sm uppercase">{slide.address}</p>
              </div>
            </div>
          </SwiperSlide>
        ))}
