    ...
    return (
        <div className="bg-orange-50 pt-8 md:m-12 p-4 m-4 rounded-lg">
            ...
            <div className='flex justify-center items-center'>
                <div style={{ height: '15px', width: '15px', backgroundColor: 'red' }}>
                </div>
                <h4 className='ms-4'>Already Booked</h4>
            </div>
            <div className='flex justify-center items-center'>
                <div style={{ height: '15px', width: '15px', backgroundColor: 'rgb(252, 233, 85)' }}>
                </div>
                ...
                <div className="grid grid-cols-2">
                    {
                        halfSeats1?.map(seat =>
                            ...
                            <button onClick={() => handleSeatSelect(seat)} className="btn mt-2 ms-2" style={{
                                background: selectedSeats.includes(seat) ? 'orangered' : 'rgb(252, 233, 85)'
                            }} disabled={bookedSeat.includes(seat) ? true : false} key={seat}>
                                {seat}
                            </button>
                        )
                    }
            ...
            <div className="flex justify-center mt-4">
                ...
                {
                    counter > 0 && <button className="btn btn-block brand-btn w-1/2">Book Ticket</button>
                }
