...
const PrivacyAndPolicy = () => {
  return (
    <div>
      <div className="max-w-[1200px] px-4 sm:px-4 lg:px-0 md:px-0 mx-auto mt-36 mb-8">
        <h1 className="text-4xl font-normal text-orange-600 my-3">
          PRIVACY POLICY
        </h1>
        <div className="space-y-5 pl-5 text-lg mt-3">
          ...
          <p>
            <span className="text-orange-500">Note:</span> Kindly note that our
            privacy policy is subject to change at any time without prior
            notice. To ensure that you are aware of any changes, please review
          ...
          <div className="pl-5 mt-3 space-y-5 text-lg">
            ...
            <div className="space-y-1">
              ...
              <p>
                ...
                anonymous to us. You always have the option to not provide
                information by choosing not to use a particular service or
                feature on the Website. We compile your usage behaviour and
                personal information and the information on an aggregate basus
                to internal research to better enhance our product offerings to
                serve you better.. This information may include the URL that you
                just came from (whether this URL is on our Website or not),
              ...
              <p>
                ...
                effectiveness, and promote trust and safety. We offer certain
              ...
              <p>
                ...
                instrument details.If you post messages or leave a feedback for
                us, we will collect that information you provide to us. We
                retain this information as necessary to resolve disputes,
                provide customer support and troubleshoot problems as permitted
                by law.
              </p>
              ...
              <p>
                ...
                based on your previous orders and your interests. However, data
                protection is a matter of trust and your privacy is important to
                us. We shall therefore use your name and other information which
                relates to you in the manner set out in this Privacy Policy. We
                will only collect information where it is necessary for us to do
                so and we will only collect information
              </p>
            </div>
          </div>
          <div className="pl-5 mt-3 space-y-5 text-lg">
            ...
            <div className="space-y-1">
              ...
              <p>
                ...
                information publicly and with our partners – like bus operators,
                agents or connected sites. For example, we may share information
                publicly to show trends about the general use of our services.
                We may also share consolidated information provided by
                like-minded users with bus operators without ever taking
          ...
          <div className="pl-5 mt-3 space-y-5 text-lg">
            ...
            <div className="space-y-1">
              ...
              <p>
                ...
                the details of the information we collect, how we use it, and
